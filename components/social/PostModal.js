...
function Modal() {
  ...
  const sendComment = async (e) => {
    ...
    // close modal and empty the current comment
    setIsOpen(false);
    setComment("");
        ...
        <div className="flex items-start justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block align-bottom bg-black rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full">
              <div className="flex items-center px-1.5 py-2 border-b border-y-gray-600">
                <div
                    ...
                    <div className="flex-grow mt-2">
                      ...
                      <div className="flex items-center justify-between pt-2.5">
                        <div className="flex items-center">
                          <div className="icon">
                            <PhotographIcon className="text-[#E20910] h-[22px]" />
                          </div>
                        ...
                        <button
                          className="bg-[#E20910] text-white rounded-full px-4 py-1.5 font-bold shadow-md hover:bg-[#E20910] disabled:hover:bg-[#E20910] disabled:opacity-50 disabled:cursor-default"
                          type="submit"
                          onClick={sendComment}
